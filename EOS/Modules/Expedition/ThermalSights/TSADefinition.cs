...
namespace EOS.Modules.Expedition.ThermalSights
{
    ...
    public class TSShader
    {
        ...
        public Color ReticuleColorA { get; set; } = new() { r = 1f, g = 1f, b = 1f, a = 1f };

        public Color ReticuleColorB { get; set; } = new() { r = 1f, g = 1f, b = 1f, a = 1f };

        public Color ReticuleColorC { get; set; } = new() { r = 1f, g = 1f, b = 1f, a = 1f };
